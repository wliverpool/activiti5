...
<head>
	...
	function beforeSend() {
		$('input[name=p_DT_realityStartTime]').val($('#realityStartDate').val());
		$('input[name=p_DT_realityEndTime]').val($('#realityEndDate').val());
	}
	</script>
</head>
<body>
	<form action="${ctx }/leaveReportComplete/${task.id}" class="form-horizontal" method="post" onsubmit="beforeSend()">
