        ...
        $(function() {
            $('.change-retries').click(function() {
                ...
                if (isNaN(retries)) {
                    ...
                    location.href = ctx + '/changeJobRetries/' + $(this).data('jobid') + "?retries=" + retries;
                }
            });
        });
    </script>
            ...
            <td>
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu" style="min-width: 100px;margin-left: -70px;">
                        <li><a href="${ctx }/executeJob/${job.id}"><i class="icon-play"></i>执行</a></li>
                        <li><a href="${ctx }/jobDelete/${job.id}"><i class="icon-trash"></i>删除</a></li>
