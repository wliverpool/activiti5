...
<ul class="nav nav-pills">
    <li class="active"><a href="${ctx}/identityUserList"><i class="icon-user"></i>用户管理</a></li>
    <li><a href="${ctx}/identityGroupList"><i class="icon-list"></i>组管理</a></li>
</ul>
<hr>
...
<div class="row">
            ...
            <table width="100%" class="table table-bordered table-hover table-condensed">
                ...
                <c:forEach items="${page.result }" var="user">
                    <tr id="${user.id}">
                        ...
                        <td>
                            <a class="btn btn-danger btn-small" href="${ctx}/identityUserDelete/${user.id}"><i class="icon-remove"></i>删除</a>
    ...
    <!-- 新增、编辑用户的Model -->
    <div class="span4">
        <form action="${ctx }/identityUserSave" class="form-horizontal" method="post">
            <fieldset>
    ...
    <div id="setGroupsModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="setGroupsModalLabel" aria-hidden="true">
        ...
        <div class="modal-body">
            <form action="${ctx}/identityGroupSet" method="POST">
