...
<ul class="nav nav-pills">
    <li><a href="${ctx}/identityUserList"><i class="icon-user"></i>用户管理</a></li>
    <li class="active"><a href="${ctx}/identityGroupList"><i class="icon-list"></i>组管理</a></li>
</ul>
<hr>
...
<div class="row">
            ...
            <table width="100%" class="table table-bordered table-hover table-condensed">
                ...
                <c:forEach items="${page.result }" var="group">
                    <tr id="${group.id}">
                        ...
                        <td>
                            <a class="btn btn-danger btn-small" href="${ctx}/identityGroupDelete/${group.id}"><i class="icon-remove"></i>删除</a>
    ...
    <div class="span4">
        <form action="${ctx }/identityGroupSave" class="form-horizontal" method="post">
